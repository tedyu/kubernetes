...
func (_m *MockManager) GetUIDForMirrorPodPendingTermination(_a0 string) (kubelettypes.UIDWithGracePeriod, bool) {
	ret := _m.Called(_a0)

	var r0 kubelettypes.UIDWithGracePeriod
	if rf, ok := ret.Get(0).(func(string) kubelettypes.UIDWithGracePeriod); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(kubelettypes.UIDWithGracePeriod)
		}
	}
